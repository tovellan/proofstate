...
```sh
uv tool install git+https://github.com/tovellan/proofstate@v0.3.3
proofstate --version
```
...
No package is published to PyPI in version 0.3.3.
...
step before ProofState. Version 0.3.3 does not fetch remote evidence, execute
...
ProofState 0.3.3 supports local Git worktrees and SHA-1 or SHA-256 Git object
