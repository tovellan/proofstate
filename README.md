...
```sh
uv tool install git+https://github.com/tovellan/proofstate@v0.2.0
proofstate --version
```
...
No package is published to PyPI in version 0.2.0.
...
step before ProofState. Version 0.2.0 does not fetch remote evidence, execute
...
ProofState 0.2.0 supports local Git worktrees and SHA-1 or SHA-256 Git object
